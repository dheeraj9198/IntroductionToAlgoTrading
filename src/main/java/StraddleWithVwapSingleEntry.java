...
public class StraddleWithVwapSingleEntry {
    ...
    public static void main(String[] strings) throws FileNotFoundException {
        ...
        PrintWriter printWriter = new PrintWriter(new File("FinalResults/backTestOutput/"+StraddleWithVwapSingleEntry.class.getSimpleName()+"-" + new Date().getTime()));
        printWriter.flush();
